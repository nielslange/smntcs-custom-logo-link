...
Cypress.Commands.add("login", () => {
	...
	cy.visit('http://localhost:10056/wp-login.php').wait(500);
...
Cypress.Commands.add("checkPluginActivation", () => {
	cy.viewport(1200, 2000);
	cy.visit('http://localhost:10056/wp-admin/plugins.php').wait(500);
...
Cypress.Commands.add("checkPluginSettings", () => {
	cy.viewport(1200, 2000);
	cy.visit( 'http://localhost:10056/wp-admin/customize.php' ).wait(500);
...
Cypress.Commands.add("checkThemeActivation", (slug) => {
	cy.viewport(1200, 2000);
	cy.visit('http://localhost:10056/wp-admin/themes.php').wait(500);
...
Cypress.Commands.add("checkSiteTitleLink", (selector) => {
	cy.viewport(1200, 2000);
	cy.visit('http://localhost:10056/' ).wait(500);
	cy.get("body").then($body => {
